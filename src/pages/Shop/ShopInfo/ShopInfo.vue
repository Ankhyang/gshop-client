  ...
  >
    <div class="info-content">
      <section class="section">
        ...
        <div class="delivery">
          <div> <span class="delivery-icon">{{shopInfo.description}}</span> <span>由商家配送提供配送，约 {{shopInfo.deliveryTime}} 分钟送达，距离 {{shopInfo.distance}}</span> </div>
      ...
      <section class="section">
        ...
        <ul class="detail">
          ...
          <li><span class="bold">商家电话</span> <span>2323232323</span></li>
